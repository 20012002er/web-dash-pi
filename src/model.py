...
Ported from the original OpenClaw-DashPi project. RefreshInfo no longer
tracks an image_hash (the web dashboard does not render images), but
LoopManager, Loop, and PluginReference retain their full scheduling,
caching, randomization, and priority logic unchanged.
"""
...
class RefreshInfo:
    ...
    def __init__(self, refresh_type, plugin_id, refresh_time, loop=None):
